...
def run_black_jack(player,dealer,batch_size,num_episodes,game_sample_size,avg_score_sample_size):
    ####### LOOP #####################
...
if __name__ == '__main__':
    ...
    run_black_jack(player,dealer,batch_size=32,num_episodes=1000,game_sample_size=2000,avg_score_sample_size=10000)

    player.create_policy_df()

    player.save('/Users/befeltingu/DeepRL/Data/models/blackjack_simple_model.h5')
